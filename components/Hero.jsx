          ...
          <div className="max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-6 text-gray-600">
                Looking for quick start on your next Blog? Welcome to <span className="text-indigo-600">BlogXL </span>,
                where developers like you share their expertise through a diverse collection of <span className="text-red-600">blogs </span>.
                Whether you&apos;re blogging a <span className="text-yellow-600">blog </span> or describing new features, find the
                <span className="text-blue-600">perfect </span> starting point right there.
              </p>
            </div>
